...
gene_ids = sort(rownames(exprSet))
...
# Load the gene name annotations previously extracted from
# the result object
...
default_go = 'GO:0035458' # chemokine activity
# Prepare the individual animal choices
animals_choices <- sort(unique(as.character(exprSet$Animal)))
